...
export const products = [
  {
    name: "Kissed Stickers Sheet",
    price: 6.95,
    description: "QR Codes on a sheet in quadruple pair.",
    ratings: 4,
    numOfReviews: 8,
    _id: 1,
    productId: 1,
    images: [
      {
        url: "https://firebasestorage.googleapis.com/v0/b/qrlab-shop.appspot.com/o/files%2F1704567794849?alt=media&token=916557bc-abf0-4095-ae6a-fee7ca511c0f",
      },
    ],
  },
]
...
export const productDetailsReducer = (state = { product: {} }, action) => {
  switch (action.type) {
    ...
    case PRODUCT_DETAILS_SUCCESS:
      return {
        loading: false,
        product: products.filter((item) => item._id == action.payload)[0], // product details from backend
        success: true,
      }
